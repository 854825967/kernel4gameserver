...
class TestAllTypes : public ::google::protobuf::Message {
 public:
  ...
  ::proto3_arena_unittest::TestAllTypes_OptionalGroup* _slow_release_optionalgroup();
  public:
  const ::proto3_arena_unittest::TestAllTypes_OptionalGroup& optionalgroup() const;
  ::proto3_arena_unittest::TestAllTypes_OptionalGroup* mutable_optionalgroup();
  ::proto3_arena_unittest::TestAllTypes_OptionalGroup* release_optionalgroup();
  void set_allocated_optionalgroup(::proto3_arena_unittest::TestAllTypes_OptionalGroup* optionalgroup);
  ::proto3_arena_unittest::TestAllTypes_OptionalGroup* unsafe_arena_release_optionalgroup();
 ...
 public:
  ...
  const ::proto3_arena_unittest::TestAllTypes_RepeatedGroup& repeatedgroup(int index) const;
  ::proto3_arena_unittest::TestAllTypes_RepeatedGroup* mutable_repeatedgroup(int index);
  ::proto3_arena_unittest::TestAllTypes_RepeatedGroup* add_repeatedgroup();
