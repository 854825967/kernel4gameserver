...
class Foo : public ::google::protobuf::Message {
 public:
  ...
  static const NestedEnum FOO = Foo_NestedEnum_FOO;
  static const NestedEnum BAR = Foo_NestedEnum_BAR;
  static const NestedEnum BAZ = Foo_NestedEnum_BAZ;
...
class FooWithExtraFields : public ::google::protobuf::Message {
 public:
  ...
  static const NestedEnum FOO = FooWithExtraFields_NestedEnum_FOO;
  static const NestedEnum BAR = FooWithExtraFields_NestedEnum_BAR;
  static const NestedEnum BAZ = FooWithExtraFields_NestedEnum_BAZ;
  static const NestedEnum QUX = FooWithExtraFields_NestedEnum_QUX;
  static inline bool NestedEnum_IsValid(int value) {
