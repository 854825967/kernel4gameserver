...
void NestedMessage::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const NestedMessage* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const NestedMessage*>(
      &from);
  if (source == NULL) {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_repeated_nested_message;
        if (input->ExpectTag(18)) goto parse_repeated_import_no_arena_message;
        break;
      }
      ...
      case 2: {
        if (tag == 18) {
         parse_repeated_import_no_arena_message:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
...
void ArenaMessage::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const ArenaMessage* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const ArenaMessage*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
